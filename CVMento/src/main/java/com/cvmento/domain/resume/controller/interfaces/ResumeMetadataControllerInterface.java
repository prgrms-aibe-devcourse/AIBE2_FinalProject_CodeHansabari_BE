...
@Tag(name = "이력서 메타데이터", description = "이력서 작성에 필요한 메타데이터 API - 기술스택, Enum 옵션 등")
public interface ResumeMetadataControllerInterface {
    ...
    ResponseEntity<CommonResponse<ResumeMetadataResponse>> getResumeMetadata();
}